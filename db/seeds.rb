...
EventListing.create(user_id: 2, event_id: 2, saved: true, seen: false, booked: false )
EventListing.create(user_id: 2, event_id: 3, saved: true, seen: false, booked: false )
EventListing.create(user_id: 2, event_id: 4, saved: true, seen: false, booked: false )
EventListing.create(user_id: 3, event_id: 1, saved: true, seen: false, booked: false )
EventListing.create(user_id: 3, event_id: 6, saved: true, seen: false, booked: false )
EventListing.create(user_id: 3, event_id: 7, saved: true, seen: false, booked: false )
EventListing.create(user_id: 3, event_id: 8, saved: true, seen: false, booked: false )
EventListing.create(user_id: 5, event_id: 1, saved: true, seen: false, booked: true )
EventListing.create(user_id: 5, event_id: 10, saved: true, seen: false, booked: true )
EventListing.create(user_id: 5, event_id: 11, saved: true, seen: false, booked: false )
EventListing.create(user_id: 5, event_id: 12, saved: true, seen: true, booked: false )
